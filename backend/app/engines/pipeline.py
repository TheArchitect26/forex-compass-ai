...
async def run_signal_pipeline_for_pair(db, pair: str, source: str = "api_scan") -> dict | None:
    ...
    if blocked_by_synthetic_policy(s, settings.ALLOW_SYNTHETIC_SIGNALS):
        return None
    ...
    snap = config_snapshot(profile, runtime={"allow_synthetic_signals": settings.ALLOW_SYNTHETIC_SIGNALS, "default_slippage_pips": settings.DEFAULT_SLIPPAGE_PIPS, "default_spread_pips": settings.DEFAULT_SPREAD_PIPS})
